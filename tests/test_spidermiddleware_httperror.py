...
class TestHttpErrorMiddleware(TestCase):
    ...
    def test_process_spider_input(self):
        self.assertEqual(None, self.mw.process_spider_input(self.res200, self.spider))
    ...
    def test_process_spider_exception(self):
        ...
        self.assertEqual(None, self.mw.process_spider_exception(self.res404, Exception(), self.spider))
    ...
    def test_handle_httpstatus_list(self):
        ...
        self.assertEqual(None, self.mw.process_spider_input(res, self.spider))

        self.spider.handle_httpstatus_list = [404]
        self.assertEqual(None, self.mw.process_spider_input(self.res404, self.spider))
...
class TestHttpErrorMiddlewareSettings(TestCase):
    ...
    def test_process_spider_input(self):
        self.assertEqual(None, self.mw.process_spider_input(self.res200, self.spider))
        self.assertRaises(HttpError, self.mw.process_spider_input, self.res404, self.spider)
        self.assertEqual(None, self.mw.process_spider_input(self.res402, self.spider))
    ...
    def test_meta_overrides_settings(self):
        ...
        self.assertEqual(None, self.mw.process_spider_input(res404, self.spider))
